...
csv_file  = "../results/uq_results.csv"   # produced by uq_forward_sensitivity_venable.py
...
ax1.plot(x[1:], qoi[1:], color="k", linewidth=1.2, label="QoI")
ax1.fill_between(x[1:], qoi[1:] - sigma[1:], qoi[1:] + sigma[1:],
...
# (b) 2σ time series
ax2.plot(x[1:], 2.0*sigma[1:], linewidth=1.2, color="red")
